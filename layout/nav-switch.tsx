...
const NavSwitch: FC<MNavbType> = ({ open, toggleNavbar }) => {
  ...
  return (
    <div className="fixed right-[16px] top-[16px] z-[101]">
      <div
        onClick={toggleNavbar}
        className="relative cursor-pointer w-[40px] h-[40px] shadow-lg shadow-white/10 rounded-sm border-2 border-white z-[150]"
      >
